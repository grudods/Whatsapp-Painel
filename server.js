...
// ===== WEBHOOK DO AUTORESPONDER (CORRIGIDO) =====
app.post('/api/webhook', (req, res) => {
    console.log('📩 Webhook recebido!');
    console.log('Corpo da requisição:', JSON.stringify(req.body, null, 2));

    // ✅ ESTRUTURA CORRETA DO AUTORESPONDER
    // req.body tem: appPackageName, messengerPackageName, query
    // query tem: sender, message, isGroup, etc
    ...
    if (!conversas[conversa_id]) {
        ...
        console.log(`✨ Nova conversa criada: ${conversa_id}`);
    }
    ...
    // ✅ RESPOSTA CORRETA PARA O AUTORESPONDER
    res.json({
        replies: [
            { 
